...
charts = [
    {
        ...
        'multicluster_key': '.Values.grafana.sidecar.dashboards.multicluster',
    },
    {
        ...
        'type': 'json',
        'min_kubernetes': '1.14.0-0',
        'multicluster_key': '(or .Values.grafana.sidecar.dashboards.multicluster .Values.grafana.sidecar.dashboards.etcd.multicluster)'
    },
]
